    ...
    <div className="min-h-screen bg-cyber-dark">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="mt-6 bg-cyber-dark-surface/50 border border-cyber-dark-border rounded-xl p-5">
              ...
              {game.description && (
                <p className="text-cyber-text-muted mb-4">{game.description}</p>
              )}
          ...
          <aside className="lg:w-80 shrink-0">
            <div className="bg-cyber-dark-surface/50 border border-cyber-dark-border rounded-xl p-5 sticky top-24">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex justify-between">
                  <span className="text-cyber-text-muted">Jogadas</span>
                  <span className="text-cyber-text">{game.playCount}</span>
                </div>
              </div>
              ...
              <div className="mt-6 space-y-2">
                <a
                  ...
                  className="block w-full text-center px-4 py-2.5 bg-cyber-dark-surface text-cyber-text rounded-lg hover:bg-cyber-dark-surface/70 transition-colors text-sm"
                >
                  Abrir em nova aba
                </a>
              </div>
        ...
        <div className="mt-8 text-center">
          <Link
            href="/games"
            className="inline-flex items-center gap-2 text-cyber-text-muted hover:text-neon-green transition-colors"
          >
